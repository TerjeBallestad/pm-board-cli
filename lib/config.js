...
const DEFAULT_CONFIG = {
  ...
  port: 3333,
  dataDir: '.pm/data',
  // Opt-in: git-commit the data dir (debounced) after every write, so a crash,
  // git reset, or bad update loses seconds and is recoverable via git log.
  // Best paired with a data dir that is its own git repo.
  autoCommit: false,
